...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/onboardingback.svg
  SvgGenImage get onboardingback =>
      const SvgGenImage('assets/svgs/onboardingback.svg');

  /// List of all assets
  List<SvgGenImage> get values => [onboardingback];
}
